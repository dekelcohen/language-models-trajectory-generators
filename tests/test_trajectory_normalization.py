...
import common_utils
from common_utils import Trajectory, normalize_trajectory
...
class AcceptedInputs(unittest.TestCase):
    ...
    def test_bare_list_of_poses_is_wrapped(self):
        out = normalize_trajectory([[0.0, 0.1, 0.2, 0.0]])
        self.assertIsInstance(out, Trajectory)
    ...
    def test_length_six_poses_are_preserved(self):
        ...
        self.assertEqual(normalize_trajectory([pose]).points, [pose])
    ...
    def test_numpy_points_become_plain_floats(self):
        ...
        out = normalize_trajectory(Trajectory(np.array([[0.1, 0.2, 0.3, 0.0]]), "np"))
