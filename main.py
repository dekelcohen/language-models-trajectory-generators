...
if __name__ == "__main__":
    ...
    parser.add_argument("-lm", "--language_model", choices=["azure-gpt-5", "gpt-4o", "gpt-4o-mini", "gpt-4-turbo", "gpt-4", "gpt-3.5-turbo"], default="azure-gpt-5", help="select language model")
